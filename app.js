...
const CONCERNS = [
  {
    id:1, emoji:'⚖️',
    ar:{title:'الخلافات الفرعية تمزق الأمة',desc:'يؤلم الغزالي أن المسلمين يتقاتلون على فروع فقهية بينما يتركون أصول الدين. المسائل الثانوية صارت سبباً للتكفير والتفرق، والأعداء يستغلون هذا الانقسام.',solution:'علينا أن نفرّق بين الثوابت والمتغيرات. الخلاف الفقهي طبيعي لكن التعصب له مرض. يجب أن نتسع لاختلاف المذاهب كما اتسع السلف.',action:'عندما تسمع خلافاً فقهياً، اسأل: هل هذه مسألة أصول أم فروع؟ لا تُكفّر مخالفك.'},
